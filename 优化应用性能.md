...
1. 使用实时监控功能（详细使用方法请参考[性能问题定界：实时监控](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/realtime-monitor)）对应用的内存资源进行监控。正常操作应用，观察运行过程中的应用内存变化情况。当在一段时间内应用内存没有明显增加或者在内存上涨后又逐渐回落至正常水平，则基本可以排除应用存在内存问题；反之，在一段时间内不断上涨且无回落或者内存占用明显增长超出预期，那么则可初步判断应用可能存在内存问题。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.63541277433603597263935405541177:50001231000000:2800:70B83FFEFE4C76D6208847C1C3C5056259DA1C714FB551F5F849EA50BC202773.png "点击放大")
...
3. 创建模板后，将模板中的其余泳道去除勾选，仅录制Memory泳道的数据。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.78400912701463883011858333280313:50001231000000:2800:3293A2F3D9C12EBD311C0C3A0BE2122E931551091E14904F9A9FF8E276E6A2C3.png)
    
4. 点击三角按钮![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.71270869234002434704566781910142:50001231000000:2800:9AE89590883AEC143F7C6EA9C565786388D3DB38B45E0D9F254C1F3956DF9C1C.png)即开始录制。
5. 录制过程中，不断操作应用在问题场景的功能，将问题放大，便于快速定界问题点。
6. 点击下图中方块按钮或者左侧停止按钮结束录制。
    
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.22551327978300866061015333241168:50001231000000:2800:F1CA4126F8BED34006C9AB61153C394E59704FE20D0172253A4933EDFDE02265.png "点击放大")
...
7. 录制完成后，展开Memory泳道，其中ArkTS Heap表示方舟虚拟机内存，这部分内存受到方舟虚拟机的管控。Native Heap表示Native内存，主要是应用使用到的一些涉及Native的API所申请的内存以及开发者自己的Native代码所申请使用的堆内存（通常是C/C++），这部分内存需要开发者自行管理申请和释放。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.05407245420504593767389039940432:50001231000000:2800:3C6ED456FD129000917099AF5F3D49B1EA828CDDBBF8BF7B58E28CC921AD6441.png "点击放大")
...
2. 创建模板后，点击三角按钮即开始录制。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.16622749202216914164113701637942:50001231000000:2800:FA905B7E103E63FE3A9DE789E1E9CA6CD0708307806F4A39EC7FE1B090491D82.png "点击放大")
    
3. 待右侧泳道全部显示recording后则表明正在录制中。
    
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155942.17819586551943978624821990218629:50001231000000:2800:D85D294BC6D5087D4A586D17676C688723D077D848E9CFB8C6CA3ABBE9265E57.png "点击放大")
...
4. 拍摄第一次堆快照作为基准（点击图中①处拍摄按钮，待②处显示出紫色条块表示快照拍摄完成）。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.81928706643707838867041945022404:50001231000000:2800:F46743A89BA7676217C9E8F5FAF9B9E609ADC4BFA6C1F62A3346D7F7D5895C2F.png "点击放大")
    
5. 多次触发内存泄漏操作。可以操作5，7，11等这种特殊的次数。比如操作了5次对比两个快照发现有很多创建了5次没释放的场景，则可能存在内存泄漏，再操作7次，如果创建了7次那就可以确认发生了泄漏。
6. 拍摄第二次堆快照。
7. 点击下图中方块按钮或者左侧停止按钮结束录制。
    
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.56171717226286886790194979408852:50001231000000:2800:FB5A5C707379DDD2FA5466CB1CCAF398E8814BD1AB80415200A5CAA12234F5C5.png "点击放大")
...
1. 在每次拍摄堆快照之前，虚拟机都会触发GC，所以理论上堆快照内存在的对象都是当前虚拟机已经无法GC掉的对象。我们可以将两个堆快照进行比较，来查看哪些对象是在触发问题场景时新增了且不能释放的。切换到窗口下方详情区域的“Comparison”页签，将两次快照进行对比。图中数据的含义是以Snapshot2作为基准，Snapshot2对比Snapshot1的数据变化量。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.13914911309857208344895881838247:50001231000000:2800:90D7DB6F67ACB68A4EE60AADD1706CF2F6CD13E794B5E965751BFFFDC7C83F73.png "点击放大")
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.19110913452851817819094674578612:50001231000000:2800:4CC445335E633BA8BE562A7E836FC0731D2A9EC320ACDEAF168B90E3A4FD3CAD.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.31703200357176962138818903469029:50001231000000:2800:A9A0B1CA31B2D1432779A5AD8AAA9AADC8849AAA25D0142D039D540A7EA68DAF.png)
...
16. @Entry
17. @Component
18. struct HelloWorldPage {
19.   @State message: string = 'Hello World';
20.   private people: People = new People(20, "Tom");
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.53845806338001354969975485675617:50001231000000:2800:07CF90E4D3526BE3C87F53825BB526FBDD949E7F017871DA306112A9149486DB.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.67477742413982657851059051734777:50001231000000:2800:FBBEC248FCAEEE447FC9BEE187F6E1BE59696B17019B354C3A4D8F2A2122D35F.png "点击放大")

每个函数展开后为函数内的各个属性：

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.82767203431315077498237821847738:50001231000000:2800:4810E3253D5AD443ADE13CAE300F97551011C4F14648B5AD331FEC74F184CAC8.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.77716647151994826674611784996213:50001231000000:2800:3DF5AAA16C2B04C1B53D76F45EC73AD9CCAC7AF4DD3BCD36971EB0D242E46229.png)

**ArkInternalConstantPool**

虚拟机创建的常量池，ArkTS代码层面不可见，涉及到的字符串常量会在(array)标签中展示：

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.53940065410134467301323586484640:50001231000000:2800:C01C70B696D423721EE3370E4299C8AAF965C2C3739BB2A7AD9E28B4E9413CA2.png "点击放大")

**LexicalEnv**

闭包变量上下文；闭包是一个链状结构，如下所示：

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.52121758314436690617787133401427:50001231000000:2800:96BCB9DE1C4D313A869C3EBEF82956C67CB05B30E03292AE93BB59A53847EE12.png)
...
![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.00565997451687658732446382262474:50001231000000:2800:D1FE9AB19153BC77020BF97D8AFC0F86FE09804317A9B30AE86FCA103EB42B45.png)

对于实例化对象，一般没有constructor，则需要展开__proto__属性后查找constructor；

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.50226199185982716791174498226804:50001231000000:2800:6331AB4F922258473DFED0C9B394DE078C30909EB0C44D60451AA0F01CAEC58E.png)

若对象里有一些标志性属性，可以通过在代码里搜索属性名称来找到具体是哪个对象。

如果对象间有继承关系，则可以继续展开__proto__：

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155943.97162849649257990656849060673835:50001231000000:2800:4FA97205A68073B3F049C1B817DD7C7A244BE33B85135D1E8B521BD9A1254505.png)
...
1. 创建CPU分析任务并录制相关数据，操作方法可参考[性能问题定位：深度录制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/deep-recording)，或在会话区选择**Open File**，导入历史数据。
    ...
    CPU分析任务支持在录制前单击![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.29647147951698809982011805260620:50001231000000:2800:37B8F7BCEC16ACA8B6DD7311CA9560828751421DE1BF659541B6BA2836DCA723.png)指定要录制的泳道。
...
2. “CPU Core”泳道显示当前选择调优应用或元服务的CPU的使用率。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.11872887725657228062310880329340:50001231000000:2800:B41EE0BBE829CCAB4BA531B87117BB2FE0E29665739AEAD403B0CA424675A5E0.png "点击放大")
...
3. 将其展开，子泳道显示各CPU核心调度信息、各CPU核心频率信息以及各CPU核心使用率信息。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.62663173335330651837521749365627:50001231000000:2800:AF8DEB90305320C35D496DAF2D17407F97F2F5240B316EBE7DF5BB0C9D755462.png "点击放大")
    
4. 指定时间片，查看统计信息。
    
    - 单击某个运行状态的时间片，可查询这个时间片的基本运行信息及调度时延信息。
        
        ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.73491493857935836406241147815641:50001231000000:2800:5CA28B18D18A1C7B39AD0D9B9A01E9D4003B206E91719E7194E763B55B34F48D.png "点击放大")
        
    - 框选多个时间片，则可查询多时间片的进程维度统计信息以及所有时间片的数据统计信息。
        
        ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.34354556584814056160126747505186:50001231000000:2800:5C4FB2F06F3A51B6A58EC72BDA91C4208B60A176D4D2A0420693C3E87A8C4130.png "点击放大")
        
    - 开启"View Integrated Scheduling Chain"后，点击CPU时间片泳道的节点可以查看某一个CPU运行线程的完整唤醒调度链。
        
        ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155930.63305396757622862575844333049883:50001231000000:2800:318BCFFF8FECE148571FC3EB1B734233416D192BE409F3CE1A9309A888E10DC8.png "点击放大")
...
单击工具控制栏中的![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.63204192705587950927514437908580:50001231000000:2800:79189CB3612261E320EC551F5BA0F380AEEFFF93ED1545BE2C43C8126812A9A9.png)按钮，可以设置是否为精简模式。精简模式下，trace数据量将大幅减少，主要采集当前进程、大桌面进程和render_service进程的trace数据。

![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.93303609316017443492969517269136:50001231000000:2800:1BBD5048F8403BA8CD4169B595225C8821C0A3CD5589AE20F21EB9A43DF46BE1.png "点击放大")
...
- 单击运行状态的时间片，显示线程在该片段的运行详情，包括起始时间、持续时长、运行状态、频率、线程优先级、所属进程、所属线程、上一运行状态、下一运行状态、唤醒线程，支持跳转到上个或者下个线程运行状态，支持跳转到唤醒线程状态等。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.42601795514006396637438431023948:50001231000000:2800:993AFA1EBA5F2335DC2E2F723FBA54F4880424F667A41A27FBD9945EA69037C3.png "点击放大")
...
- 框选Thread泳道中多个运行状态的时间片，可查看此时间段内的不同运行状态的线程的统计信息，包括总耗时时长、最大耗时、最小耗时、平均耗时、处于当前状态的线程数量以及线程中的中载重载数据统计。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.75538320159140705440905962485383:50001231000000:2800:1823305AFE68917D7ABCC9648E09328207F1444211658DEBEC04A9EA1D31538C.png "点击放大")
...
- 框选应用进程Process主泳道，可查看此时间段内该进程下的线程并行度统计信息。并行度数据每100ms做一次统计，可以查看100ms内运行的总线程数量、各线程并行的总时间和并行度。点选某一行，可以查看对应线程编号和运行时间段。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.55219393387775479019405573899268:50001231000000:2800:AAB35BD71EBB922DEF0EF83F85CFFC7B42210895D8475212F450E5471B591CA8.png "点击放大")
...
- 点选泳道中的Trace片段，可查看单个Trace详情，包括名称、所属进程、所属线程、起始时间、持续时长、深度等。
    ...
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.94961690585238672551623905340790:50001231000000:2800:C80710522356C338D8DBCFD5255BDFE1B4AE891BA820153DA89984EBED672F2E.png "点击放大")
    
- 框选多个Trace片段，可查看到Trace统计信息列表，包括Trace名称、此类Trace的总耗时、单个Trace的平均耗时、以及该时间段内该类Trace的触发次数等。
    
    ![](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20251216155931.88074618648205400482212849088812:50001231000000:2800:053779610FC482EB057E8CF0EAF8EEA87DDF8D2D29BCA8950FC52043933BC42D.png "点击放大")
    

[  
](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-arkts-memory-leak-analysis "案例：ArkTS内存泄漏分析")
